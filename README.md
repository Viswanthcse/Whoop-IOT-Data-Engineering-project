...
![Whoop Data Engineering pipeline architecture (GCP) - Dark Theme](whoop_architecture_dark.png)
...
![Whoop Data Engineering pipeline architecture (GCP) - Dark Theme](whoop_architecture_light.png)
